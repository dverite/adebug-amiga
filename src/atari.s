...
;	add.l	car_par_symbole(a6),a5		;fin du nom
	addq.w	#8,a5
...
.l1:
	...
	;$80	nb de car sur ligne de commande
	lea	$80(a5),a1
	move.w	argc(a6),d0
	move.b	d0,(a1)+
	moveq	#80-1,d0
...
;compare les dates dans (a0) et (a1), retour ds CCR
CmpDates:	move.l	d2,-(sp)
	move.l	(a0),d0
	move.l	d0,d1
	swap	d1
	move.l	(a1),d2
